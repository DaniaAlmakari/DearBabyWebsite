<%@ Page Title="" Language="C#" MasterPageFile="~/Members/MasterPage_Member.master" AutoEventWireup="true" CodeFile="Edit_personal_info.aspx.cs" Inherits="Members_Edit_personal_info" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="center" class="nav-justified" dir="rtl" style="width: 90%">
        ...
        <tr>
            <td class="text-left" style="font-weight: normal; font-size: medium; color: #808080; text-align: right;" colspan="3" dir="rtl">
